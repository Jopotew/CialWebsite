...
const noticias = [
  ...
  },
  {
    ...
    description: "Anahí y Aneley, dos niñas neuquinas de 1 y 5 años escucharon por primera vez.",
    img: anahi,
...
const NoticiasDesktop = () => {
  return (
    <div className="noticias-dt">
      <Link to="/novedades" className="noticias-dt__back">
        <ChevronLeft size={18} />
        <span>Novedades</span>
      </Link>

      <div className="noticias-dt__header">
        <h1 className="noticias-dt__title">Noticias</h1>
        <p className="noticias-dt__subtitle">
          Artículos y videos seleccionados sobre audiología y fonoaudiología
        </p>
      </div>

      <div className="noticias-dt__grid">
        {noticias.map((n) => {
          ...
          return (
            <a
              ...
              className="noticia-dt-card"
            >
              <div className="noticia-dt-card__img-wrap">
                <img src={n.img} alt={n.title} className="noticia-dt-card__img" />
                <span
                  className="noticia-dt-card__badge"
                  style={{ backgroundColor: badge.bg, color: badge.color }}
                >
                  {badge.label}
                </span>
              </div>
              <div className="noticia-dt-card__body">
                <div className="noticia-dt-card__source">
                  <ExternalLink size={13} />
                  <span>{n.source}</span>
                </div>
                <h2 className="noticia-dt-card__title">{n.title}</h2>
                <p className="noticia-dt-card__desc">{n.description}</p>
              </div>
            </a>
          );
        })}
